    ...
    if (methodLower.includes('visa')) {
      return (
        <svg className="w-6 h-6" viewBox="0 0 48 32" fill="none">
          ...
          <path d="M20.5 11h-3.2l-2 11h3.2l2-11zm9.6 7.1l1.7-4.6.9 4.6h-2.6zm3.6 3.9h2.9l-2.5-11h-2.7c-.6 0-1.1.3-1.3.9l-4.6 10.1h3.4l.7-1.8h4.1v1.8zm-9.3-3.6c0-2.9-4-3-4-4.3 0-.4.4-.8 1.2-.9.4-.1 1.5-.1 2.7.5l.5-2.3c-.7-.2-1.5-.5-2.6-.5-2.7 0-4.6 1.4-4.6 3.5 0 1.5 1.4 2.4 2.4 2.9 1 .5 1.4.8 1.4 1.3 0 .7-.9 1-1.7 1-1.4 0-2.2-.4-2.8-.7l-.5 2.3c.6.3 1.8.5 3 .5 2.9 0 4.8-1.4 4.8-3.6zm-11.9-7.4l-5.2 11h3.4l3.4-8.6 1.4 8.6h3.3l-2.7-11h-3.6z" fill="white"/>
        </svg>
      )
    }
