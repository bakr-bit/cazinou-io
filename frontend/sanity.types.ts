...
// Query: *[_type == "page" || _type == "post" || _type == "casinoReview" || _type == "infoPage" || _type == "loto" && defined(slug.current)] | order(_type asc) {    "slug": slug.current,    _type,    _updatedAt,  }
